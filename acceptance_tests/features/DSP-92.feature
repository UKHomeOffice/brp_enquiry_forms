...
Feature: DSP-92 Date the card became lost or stolen Personal details
	...
	Scenario: Attempting to proceed to Step Three without entering anything into the date fields
	...
	Scenario: Attempting to proceed to Step Three with valid values in the fields
		When I enter valid vales into the date fields
		And I click "Continue"
