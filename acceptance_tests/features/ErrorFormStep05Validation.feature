...
Feature: Validation for Step 05 of the Error Form

	Background:
		When I go to Step Five of the error form

	Scenario: Attempting to proceed to Step 06 the Error Form with entering an email address or ticking the checkbox
		When I click Continue
		Then I see the "Enter your email address" link
		And I see "Enter your email address"

	Scenario: Attempting to proceed to Step 06 the Error Form without filling in the first address field
	...
	Scenario: Attempting to proceed to Step 06 the Error Form without filling in the second address field
		When I check the I want to be contacted by post checkbox
	...
	Scenario: Attempting to proceed to Step 06 the Error Form without filling in the postcode field having entered a email address without a @
