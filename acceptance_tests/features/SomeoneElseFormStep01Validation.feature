...
Feature: Validation for Step 01 of the Someone Else Form
	...
	Scenario: Attempt to proceed to Step 02 after selecting the Allow someone else to collect my BRP radio button but not filling in the fields
		...
		And I see the "What is the nominee's identity document number?" link in the "/html/body/main/div[2]/div/div/ul/li[4]/a" xpath
		...
		And I see "What is the nominee's identity document number?" in the "/html/body/main/div[2]/div/form/div[1]/div[3]/label/span[2]" xpath
	...
	Scenario: Attempt to proceed to Step 02 after selecting the Change the person I requested to collect my BRP radio button but not filling in the fields
		...
		And I see "What is the nominee's identity document number?" in the "/html/body/main/div[2]/div/form/div[2]/div[3]/label/span[2]" xpath
