...
Then(/^I am on the Enrolment letter exit page$/) do
  ...
  page.should have_content('As you have not received a BRP yet and have a problem with your enrolment, please follow our Enrolment letter process to enquiry about your problem.')
