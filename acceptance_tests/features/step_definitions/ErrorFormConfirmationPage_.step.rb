When(/^I go to the Confirmation page of the error form$/) do
  ...
  fill_in('same-address-house-number', :with => '2')
  fill_in('same-address-street', :with => 'Marsham Street')
  fill_in('same-address-town', :with => 'Westminster')
  fill_in('same-address-postcode', :with => 'SW1P 4DF')
  click_button('Continue')
