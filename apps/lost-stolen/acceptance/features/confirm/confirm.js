...
Scenario('I can edit the full name field', (
  I
) => {
...
Scenario('I can edit the date of birth field', (
  I
) => {
...
Scenario('I can edit the nationality field', (
  I
) => {
...
Scenario('I can edit the brp-card number field', (
  I
) => {
...
Scenario('I can edit the phone number', (
  I
) => {
...
Scenario('I can edit the address', (
  I
) => {
